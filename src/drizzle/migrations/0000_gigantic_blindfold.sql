CREATE TYPE "public"."job_listings_experience" AS ENUM('fresher', 'mid-level', 'senior');--> statement-breakpoint
...
CREATE TYPE "public"."job_listings_wage_intervals" AS ENUM('hourly', 'yearly');--> statement-breakpoint
CREATE TYPE "public"."job_listing_application_stage" AS ENUM('applied', 'denied', 'interested', 'interviewed', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"wage" integer,
	"wageInterval" "job_listings_wage_intervals",
	"stateAbbreviation" varchar,
	"city" varchar,
	"isFeatured" boolean DEFAULT false NOT NULL,
	"locationRequirement" "job_listings_location_requirement" NOT NULL,
	"experienceLevel" "job_listings_experience" NOT NULL,
